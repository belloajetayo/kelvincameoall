...
?>
  ...
  <section id="rooms" class="section-padding" style="background:var(--sand-50);">
    <div class="container">
      ...
      <div class="suites-grid" data-branch-grid="annex">
        ...
        <!-- 7. Executive Room (The Annex - Authentic Photos) -->
        <article class="suite-card" data-room-cat="annex">
          <div class="suite-card-media">
            <span class="suite-branch-badge branch-annex">Branch 02 • The Annex</span>
            <div class="card-media-slider">
              <div class="card-media-slides">
                <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/photos/executive-room.jpg' ); ?>" alt="Executive Room at Kelvin Cameo Resort The Annex" class="active" loading="lazy">
                <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/photos/executive-room-desk.jpg' ); ?>" alt="Executive Room Work Desk, Wardrobe, and TV" loading="lazy">
                <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/photos/executive-room-bath.jpg' ); ?>" alt="Executive Room Ensuite Bathroom with Water Heater and Shower" loading="lazy">
              </div>
              <button type="button" class="card-media-nav prev" aria-label="Previous photo">‹</button>
              <button type="button" class="card-media-nav next" aria-label="Next photo">›</button>
              <div class="card-media-dots">
          ...
          <div class="suite-card-body">
            <div>
              ...
              <p class="suite-desc">
                Authentic corporate executive room featuring a king bed with plush ribbed emerald headboard, bedside intercom telephone, dedicated marble-top workstation with wardrobe and TV, and modern ensuite bathroom with water heater and glass shower enclosure.
              </p>
              <div class="suite-amenities-row">
                <span class="suite-amenity-tag">King Bed</span>
                <span class="suite-amenity-tag">Work Desk</span>
                <span class="suite-amenity-tag">Water Heater</span>
                <span class="suite-amenity-tag">Intercom Phone</span>
            ...
            <div class="suite-footer">
              ...
              <div class="suite-action-btns">
                <button type="button" class="btn btn-primary btn-sm btn-book-room" 
                  ...
                  data-room-branch="Branch 02 • The Annex"
                  data-room-img="<?php echo esc_url( get_template_directory_uri() . '/assets/photos/executive-room.jpg' ); ?>"
  ...
  <section id="banquet" class="section-padding" style="background:var(--navy-950); color:var(--white);">
    ...
    <!-- Conference & Retreat Partners / Customers -->
  <section class="partners-section dark" id="corporate-clients" style="background: var(--navy-950); padding: 5.5rem 0;">
    <div class="container">
      <div class="section-head" style="text-align: center; max-width: 800px; margin: 0 auto 3rem;">
        <span class="rc-badge" style="background: rgba(242,92,5,0.15); color: var(--orange-400); border: 1px solid rgba(242,92,5,0.3); margin-bottom: 0.75rem; display: inline-flex;">
          Our Valued Customers & Institutional Clients
        </span>
      ...
      <div style="margin-top: 3.5rem; text-align: center; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.1); border-radius: var(--radius-xl); padding: 2.5rem;">
        ...
        <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap;">
          <a href="https://wa.me/2348055558197?text=Hello%20Kelvin%20Cameo,%20we%20are%20planning%20a%20corporate%20conference/retreat%20and%20need%20a%20formal%20proposal" target="_blank" rel="noopener" class="btn btn-whatsapp btn-lg">
            Request Conference / Retreat Quote on WhatsApp
          </a>
  ...
  <section class="section-padding" style="background:var(--white);">
    <div class="container">
      ...
      <div class="capabilities-grid">
        ...
        <div class="capability-card" style="padding:0; overflow:hidden; display:flex; flex-direction:column; border-radius:var(--radius-xl); border:1px solid var(--slate-200); background:var(--white); box-shadow:var(--shadow-sm);">
          <div style="position:relative; height:200px; overflow:hidden;">
            <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/photos/swimming-pool-pergola.jpg' ); ?>" alt="Kelvin Cameo Resort Swimming Pool & Pergola" style="width:100%; height:100%; object-fit:cover;" loading="lazy">
            <span style="position:absolute; top:12px; right:12px; background:rgba(2,132,199,0.92); backdrop-filter:blur(4px); color:#fff; font-size:0.75rem; font-weight:800; padding:4px 10px; border-radius:999px;">₦3,000 / Day Pass</span>
          </div>
          <div style="padding:1.75rem; flex:1; display:flex; flex-direction:column;">
            <h4 style="font-family:var(--font-display); font-size:1.25rem; font-weight:800; color:var(--navy-900); margin-bottom:0.6rem;">Pristine Swimming Pool & Pergola Lounge</h4>
            <p style="flex:1; color:var(--slate-600); font-size:0.9rem; line-height:1.6; margin-bottom:1.25rem;">
              Crystal-clear outdoor pool equipped with water fountain jets, stainless steel safety rails, and a sheltered ivy-covered pergola terrace with artificial turf and seating. Free for in-house residents; accessible to daytime visitors for <strong>₦3,000 per entry</strong>.
            </p>
            <div style="display:flex; gap:0.4rem; flex-wrap:wrap;">
              <span class="rc-badge" style="font-size:0.7rem; background:#e0f2fe; color:#0369a1; border-color:#bae6fd;">Water Fountain Jets</span>
              <span class="rc-badge" style="font-size:0.7rem; background:#e0f2fe; color:#0369a1; border-color:#bae6fd;">Ivy Pergola Terrace</span>
              <span class="rc-badge" style="font-size:0.7rem; background:#e0f2fe; color:#0369a1; border-color:#bae6fd;">Poolside Bar & Grill</span>
            </div>
          </div>
        </div>
        ...
        <div class="capability-card" style="padding:0; overflow:hidden; display:flex; flex-direction:column; border-radius:var(--radius-xl); border:1px solid var(--slate-200); background:var(--white); box-shadow:var(--shadow-sm);">
          <div style="position:relative; height:200px; overflow:hidden;">
            <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/photos/resort/lounge-pool-table.jpg' ); ?>" alt="Billiards & Snooker Lounge" style="width:100%; height:100%; object-fit:cover;" loading="lazy">
            <span style="position:absolute; top:12px; right:12px; background:rgba(15,76,129,0.92); backdrop-filter:blur(4px); color:#fff; font-size:0.75rem; font-weight:800; padding:4px 10px; border-radius:999px;">Clubhouse Hub</span>
          </div>
          <div style="padding:1.75rem; flex:1; display:flex; flex-direction:column;">
            <h4 style="font-family:var(--font-display); font-size:1.25rem; font-weight:800; color:var(--navy-900); margin-bottom:0.6rem;">Billiards & Games Lounge</h4>
            <p style="flex:1; color:var(--slate-600); font-size:0.9rem; line-height:1.6; margin-bottom:1.25rem;">
            ...
            <div style="display:flex; gap:0.4rem; flex-wrap:wrap;">
              <span class="rc-badge" style="font-size:0.7rem; background:#f1f5f9; color:#334155; border-color:#cbd5e1;">Tournament Tables</span>
              <span class="rc-badge" style="font-size:0.7rem; background:#f1f5f9; color:#334155; border-color:#cbd5e1;">Sports Broadcasts</span>
              <span class="rc-badge" style="font-size:0.7rem; background:#f1f5f9; color:#334155; border-color:#cbd5e1;">Cocktail Bar</span>
            </div>
          </div>
        </div>
        ...
        <div class="capability-card" style="padding:0; overflow:hidden; display:flex; flex-direction:column; border-radius:var(--radius-xl); border:1px solid var(--slate-200); background:var(--white); box-shadow:var(--shadow-sm);">
          <div style="position:relative; height:200px; overflow:hidden;">
            <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/photos/resort/restaurant.jpg' ); ?>" alt="Fine Dining Restaurant & Bar" style="width:100%; height:100%; object-fit:cover;" loading="lazy">
            <span style="position:absolute; top:12px; right:12px; background:rgba(234,88,12,0.92); backdrop-filter:blur(4px); color:#fff; font-size:0.75rem; font-weight:800; padding:4px 10px; border-radius:999px;">Kitchen Masters</span>
          </div>
          <div style="padding:1.75rem; flex:1; display:flex; flex-direction:column;">
            <h4 style="font-family:var(--font-display); font-size:1.25rem; font-weight:800; color:var(--navy-900); margin-bottom:0.6rem;">Fine Dining & Bush Bar</h4>
            <p style="flex:1; color:var(--slate-600); font-size:0.9rem; line-height:1.6; margin-bottom:1.25rem;">
              Authentic Nigerian favorites — from catfish point-and-kill to fiery goat meat pepper soup, spicy asun, and smoky party jollof — complemented by savory continental cuisine prepared by culinary masters.
            </p>
            <div style="display:flex; gap:0.4rem; flex-wrap:wrap;">
              <span class="rc-badge" style="font-size:0.7rem; background:#ffedd5; color:#c2410c; border-color:#fed7aa;">Point & Kill Catfish</span>
              <span class="rc-badge" style="font-size:0.7rem; background:#ffedd5; color:#c2410c; border-color:#fed7aa;">Spicy Asun</span>
              <span class="rc-badge" style="font-size:0.7rem; background:#ffedd5; color:#c2410c; border-color:#fed7aa;">Continental Dishes</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="moving-gallery-controls-bar">
        <div class="filter-tabs-wrapper gallery-filter-bar" style="margin:0;">
          <button type="button" class="tab-btn tab-resort active" data-gallery-filter="all">All Resort Views (13)</button>
    ...
    <div class="moving-gallery-viewport" id="movingGalleryViewport">
      <div class="moving-gallery-track" id="movingGalleryTrack">
        <div class="moving-gallery-item" data-category="pool">
          <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/photos/swimming-pool-pergola.jpg' ); ?>" alt="Crystal Pool & Fountain Jets" loading="lazy">
          <div class="moving-gallery-overlay">
            <span class="moving-gallery-badge">Swimming Pool</span>
            <h4 class="moving-gallery-title">Crystal Pool & Fountain Jets</h4>
            <p class="moving-gallery-desc">Sparkling outdoor pool featuring active water fountain jets, safety perimeter railings, and outdoor bar.</p>
          </div>
        </div>
        <div class="moving-gallery-item" data-category="pool">
          <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/photos/swimming-pool-lounge.jpg' ); ?>" alt="Ivy Pergola Poolside Terrace" loading="lazy">
          <div class="moving-gallery-overlay">
            <span class="moving-gallery-badge">Poolside Terrace</span>
            <h4 class="moving-gallery-title">Ivy Pergola Poolside Terrace</h4>
            <p class="moving-gallery-desc">Sheltered wooden pergola draped in lush greenery with artificial grass, rustic seating, and live TV screen.</p>
          </div>
        </div>
        <div class="moving-gallery-item" data-category="pool">
          <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/photos/swimming-pool-sunny.jpg' ); ?>" alt="Sunlit Pool & Refreshments Bar" loading="lazy">
          <div class="moving-gallery-overlay">
            <span class="moving-gallery-badge">Pool & Bar</span>
            <h4 class="moving-gallery-title">Sunlit Pool & Refreshments Bar</h4>
            <p class="moving-gallery-desc">Golden daytime ambiance by the pool with dedicated refreshments bar and certified safety equipment.</p>
          </div>
        </div>
